...
def get_payment_gateway() -> Union[NovaEraPaymentsAPI, For4PaymentsAPI, CashtimePaymentsAPI]:
    ...
    if gateway_choice == "NOVAERA":
        ...
        raise ValueError("GATEWAY_CHOICE must be either 'NOVAERA', 'FOR4', or 'CASH'")
